...
A cuboid is a collection of six faces, namely the *north*, *south*, *east*,
*west*, *top* and *bottom* face (see the relevant picture above). We implement
...
listing of vertices. The *centroid* of the cuboid is the weighted average of
